  ...
  return (
    <Layout title="Dashboard" subtitle="Welcome back to Learning Hub">
      <div className="grid cols-3">
        <Card title="Overall Progress" subtitle="Average across all courses">
          <div style={{fontSize:36, fontWeight:900}}>{overall}%</div>
          <div className="small">Keep going! You're doing great.</div>
        </Card>
        <Card title="Recent Activity" subtitle="Your latest learning">
          <ul className="m0">
        ...
        <Card title="Tips" subtitle="Improve your retention">
          <ul className="m0">
